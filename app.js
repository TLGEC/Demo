...
document.addEventListener('DOMContentLoaded',()=>{bindCriticalButtons();migrateOldStorageKeys();if($('appVersionBadge'))$('appVersionBadge').innerText='App version: Demo v2';load();initSignaturePad();
...
/* Demo v2: surveyor panel override, flexible Sigenergy stack and cleaner CSV/tools flow */
(function(){
  const VERSION='Demo v2';
  const $ = id => document.getElementById(id);
...
/* Demo v2: sample customer loader for sales demonstrations */
(function(){
  const $ = id => document.getElementById(id);
