...
document.addEventListener('DOMContentLoaded',()=>{bindCriticalButtons();migrateOldStorageKeys();if($('appVersionBadge'))$('appVersionBadge').innerText='App version: Demo v1';load();initSignaturePad();
...
/* Demo v1: surveyor panel override, flexible Sigenergy stack and cleaner CSV/tools flow */
(function(){
  const VERSION='Demo v1';
  const $ = id => document.getElementById(id);
...
/* Demo v1: sample customer loader for sales demonstrations */
(function(){
  const $ = id => document.getElementById(id);
